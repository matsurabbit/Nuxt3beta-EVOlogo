...
<template>
  ...
  <div>
    ...
    <div id="part2">
      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 200.5 112.4" xml:space="preserve">
      <defs>
...
#parent > div {
  ...
  width: 100px;
  height: 200px;
  padding-left: 100%; /* SVG高さ / SVG幅 * 100 */
  overflow: hidden;
}
#part1, #part2 { 
  position: absolute;
...
#part1 {
  ...
  animation-timing-function: cubic-bezier(.38,1.24,.13,1.02);
}
@keyframes anim {
  0% { 
    top: -300px;
  ...
  30% {
    top: 0px;
    left: -0px;
    /*filter: drop-shadow(0px 0px 3px #096);*/
  }
  100% {
    top: 0px;
    left: -0px;
